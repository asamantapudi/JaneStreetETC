    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            */
            ...
            int[] sellPrice = {1001,4200,4202,8400,3959,5562,4267};
            int[] buyPrice = {999,4199,4200,8398,3957,5561,4259};
            ...
            while((endTime - startTime)/1000 < 60.0){
            ...
            int counter = 0;
            while(counter < id){
                to_exchange.println(("CANCEL " + id).toUpperCase());
                reply = from_exchange.readLine().trim();
                System.err.printf("The exchange replied: %s\n", reply);
            }
